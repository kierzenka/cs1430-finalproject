...
def make_deep_green_seq_model(img_height, img_width): 
    ...
    [
        ...
        Conv2D(64, kernel_size=(3, 3), activation='relu', strides=1, padding='same', name='conv2'),
        Conv2D(64, kernel_size=(3, 3), activation='relu', strides=1, padding='same', name='conv2'),
        MaxPool2D((2,2), strides=(2,2)), 
        Conv2D(128, kernel_size=(5, 5), activation='relu', strides=1, padding='same', name='conv3'),
        Conv2D(128, kernel_size=(5, 5), activation='relu', strides=1, padding='same', name='conv3'),
        MaxPool2D((2,2), strides=(2,2)), 
        Conv2D(256, kernel_size=(7, 7), activation='relu', strides=1, padding='same', name='conv4'),
        Conv2D(512, kernel_size=(7, 7), activation='relu', strides=1, padding='same', name='conv5'),
        MaxPool2D((2,2), strides=(2,2)), 
