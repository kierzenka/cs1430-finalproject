...
# HOW TO USE THIS: 
# 1. Download gtFine_trainvaltest.zip and leftImg8bit_trainvaltest.zip from www.cityscapes-dataset.net 
# 2. Install cityscapes: python -m pip install cityscapesscripts
# 3. export CITYSCAPES_DATASET=`pwd` (NOTE: on Windows, add the path to the data folder in your environment variables)
# 4. cd into venv/Lib/site-packages/helpers and paste this entire file into labels.py
# 5. cd into venv/Lib/site-packages/cityscapesscripts and run preparation/createTrainIdLabelImags.py
# The data should now be updated with vegetation/non-vegetation. The filepaths can be found using preprocess_cityscapes.py
